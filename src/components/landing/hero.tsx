    ...
    return (
        ...
        >
            ...
            <div className="z-10 px-4 max-w-5xl">
                ...
                >
                    Stop staring at a blank screen. Upload your app screenshot and let AI generate high-converting text for iOS, Android, Twitter, and LinkedIn in seconds. <br className="hidden md:block" />
